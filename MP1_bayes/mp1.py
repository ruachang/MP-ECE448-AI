...
# * compute the accuracy and recall of the predicted label
...
"""
def main(args):
    # * dir and whether use porter stemmer and turn all word to lowercase
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='CS440 ste MP1 Naive Bayes')
